...
public abstract class Holiday implements HolidayInteraction, HolidayReward {
	...
	/**
	 * The cycled event for this holiday which is only created once during runtime to work
	 * as a pulse
	 */
	...
	/**
	 * Cleans up and finishes the holiday, this is typically
	 * referenced to when the holiday has been active and is no
	 * longer active.
	 */
	...
	/**
	 * Determines if the server date is before the end date, and after 
