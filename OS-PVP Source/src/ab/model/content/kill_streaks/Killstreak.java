package ab.model.content.kill_streaks;
	...
	public enum Type {
		ROGUE(10, 
			...
			new KillstreakReward(7) {
				...
				@Override
				public void append(Player player) {
					player.getItems().addItemUnderAnyCircumstance(2996, 8);
					player.sendMessage("You are on a 7 rogue killstreak, you have been given 8 pk tickets.");
				}
			},
			new KillstreakReward(8) {
				...
				public void append(Player player) {
					...
					player.sendMessage("You are on a 8 rogue killstreak, you have been given 10 pk tickets.");
				}
			},
			new KillstreakReward(9) {
				...
				public void append(Player player) {
					...
					player.sendMessage("You are on a 9 rogue killstreak, you have been given 12 pk tickets.");
				}
			},
