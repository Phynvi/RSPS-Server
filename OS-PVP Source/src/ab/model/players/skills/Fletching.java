...
public class Fletching extends SkillHandler {
	...
	SHORTBOW(new int[][] {{34189, 1}, {34188, 5}, {34187,10}, {34186,28}}, 1511, 50, 5, 5),
	LONGBOW(new int[][] {{34185, 1}, {34184, 5}, {34183, 10}, {34182, 28}}, 1511, 48, 10, 10),
	ARROW_SHAFT(new int[][] {{34193, 1}, {34192, 5}, {34191, 10}, {34190, 28}}, 1511, 52, 1, 5),
	OAK_SHORTBOW(new int[][] {{34189, 1}, {34188, 5}, {34187,10}, {34186,28}}, 1521, 54, 20, 17),
	OAK_LONGBOW(new int[][] {{34185, 1}, {34184, 5}, {34183, 10}, {34182, 28}}, 1521, 56, 25, 25),
	OAK_STOCK(new int[][] {{34193, 1}, {34192, 5}, {34191, 10}, {34190, 28}}, 1521, 9442, 24, 16),
	WILLOW_SHORTBOW(new int[][] {{34189, 1}, {34188, 5}, {34187,10}, {34186,28}}, 1519, 60, 35, 33),
	WILLOW_LONGBOW(new int[][] {{34185, 1}, {34184, 5}, {34183, 10}, {34182, 28}}, 1519, 58, 40, 42),
	WILLOW_STOCK(new int[][] {{34193, 1}, {34192, 5}, {34191, 10}, {34190, 28}}, 1519, 9444, 39, 22),
	MAPLE_SHORTBOW(new int[][] {{34189, 1}, {34188, 5}, {34187,10}, {34186,28}}, 1517, 64, 50, 50),
	MAPLE_LONGBOW(new int[][] {{34185, 1}, {34184, 5}, {34183, 10}, {34182, 28}}, 1517, 62, 55, 58),
	MAPLE_STOCK(new int[][] {{34193, 1}, {34192, 5}, {34191, 10}, {34190, 28}}, 1517, 9448, 54, 32),
	YEW_SHORTBOW(new int[][] {{34189, 1}, {34188, 5}, {34187,10}, {34186,28}}, 1515, 68, 65, 68),
	YEW_LONGBOW(new int[][] {{34185, 1}, {34184, 5}, {34183, 10}, {34182, 28}}, 1515, 66, 70, 75),
	YEW_STOCK(new int[][] {{34193, 1}, {34192, 5}, {34191, 10}, {34190, 28}}, 1515, 9452, 69, 50),
	MAGIC_SHORTBOW(new int[][] {{34189, 1}, {34188, 5}, {34187,10}, {34186,28}}, 1513, 72, 80, 83),
	MAGIC_LONGBOW(new int[][] {{34185, 1}, {34184, 5}, {34183, 10}, {34182, 28}}, 1513, 70, 85, 92);
	
	private int[][] buttonId;
	private int logid, product, level;
	private int xp;
	
	private fletchingData(final int[][] buttonId, final int logid, final int product, final int level, final int xp) {
	...
	private static final int[][] DATA = {
		{1521, 54, 20, 17, 56, 25, 25, 0, 9442},
		{1519, 60, 35, 33, 58, 40, 41, 1, 9444},
		{1517, 64, 50, 50, 62, 55, 58, 2, 9448},
		{1515, 68, 65, 68, 66, 70, 75, 3, 9452},
		{1513, 72, 80, 83, 70, 85, 91, 4, 9440},
	};
